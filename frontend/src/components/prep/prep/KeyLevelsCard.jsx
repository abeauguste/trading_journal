...
export default function KeyLevelsCard({ pdh, pdl, pdc, globexHigh, globexLow, globexOpen, weeklyOpen, monthlyOpen, roundAbove1, roundAbove2, roundBelow1, roundBelow2, currentPrice }) {
